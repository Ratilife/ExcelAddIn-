...
![Интерфейс надстройки RatiTools в Excel](images/interface-screenshot.png)

> **Примечание:** Замените `images/interface-screenshot.png` на путь к вашему изображению. Рекомендуется создать папку `images` в корне проекта для хранения скриншотов.
